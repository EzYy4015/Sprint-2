                    ...
                    if($bookingDateTime>=$time_now){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td><a class='booking_buttons' href='include/add_appointment.php?bID=$row[bookingID]&userID=$userID&btime=$row[bookingTime]&bdate=$row[bookingDate]&update=1'>Get</td>
                                </tr>";
                            } 
                            echo "</table>";
