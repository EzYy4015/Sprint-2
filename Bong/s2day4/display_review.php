        ...
        if(mysqli_num_rows($result) > 0){
            while ($row = mysqli_fetch_assoc($result)){
                ...
                if($row["reviewVisible"]==1){
                    echo"<a onclick='confirmHideReview()' class='review_buttons' href= 'change_review_visibility.php?rID=$row[reviewID]'>Hide</a>";
                }
                else{
                    echo"<a onclick='confirmShowReview()' class='review_buttons' href= 'change_review_visibility.php?rID=$row[reviewID]'>Show</a>";
                }
                echo"<a onclick='confirmDeleteReview()' class='delete_buttons' href= 'delete_review.php?rID=$row[reviewID]'>Delete</a>";
                echo "</div>";
                echo "</div>";
            }
        }
