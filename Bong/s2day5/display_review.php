    ...
    if(isset($_GET['filter_variations']) && isset($_GET['filter_visibility'])){
        ...
        if(mysqli_num_rows($result) > 0){
            while ($row = mysqli_fetch_assoc($result)){
                ...
                if($row["reviewVisible"]==1){
                    echo"<a onclick='return confirmHideReview()' class='review_buttons' href= 'change_review_visibility.php?rID=$row[reviewID]'>Hide</a>";
                }
                else{
                    echo"<a onclick='return confirmShowReview()' class='review_buttons' href= 'change_review_visibility.php?rID=$row[reviewID]'>Show</a>";
                }
                echo"<a onsubmit='return confirmDeleteReview()' class='delete_buttons' href= 'delete_review.php?rID=$row[reviewID]'>Delete</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            }
        ...
        if(mysqli_num_rows($result) > 0){
            while ($row = mysqli_fetch_assoc($result)){
                ...
                echo"<a onclick='return confirmDeleteReview()' class='delete_buttons' href= 'delete_review.php?rID=$row[reviewID]'>Delete</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            }
