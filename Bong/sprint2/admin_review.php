...
<body>
    ...
    <div class="mainbody">
        ...
        <div class=add_review_admin>
            <form class = "form" action = "add_review_process.php" method = "post">
                ...
                <div class="add_review_container">
                    ...
                    <textarea name = "comment" rows = "1" cols = "50" placeholder = "Write something..."></textarea>
                </div>

                <div class="add_review_container">
                    <input class="add_review" type = "submit" value = "Submit">
                </div>
            </form>
        </div>
        ...
        <script src="script/review_action.js"></script>
