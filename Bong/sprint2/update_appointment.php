        ...
        <div class="slot_container">
            <fieldset class="slot_fieldset">
                ...
                <?php
                    ...
                    $query1.="UPDATE acc_bookings SET bookingStatus = '2' WHERE bookingID=$bookingID AND accID=$accID ";
                    ...
                    if($bookingDateTime>=$time_now){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if($bookingDateTime>=$time_now){
                                    echo "<td><a class='booking_buttons' href='include/add_appointment.php?bID=$row[bookingID]&userID=$userID&btime=$row[bookingTime]&bdate=$row[bookingDate]&update=1'>Get</a></td></tr>";
                                }
                        ...
                        echo "<div class='result'>Over the time to update appointment. \nPage will be redirected after 2 seconds</div>";
                        header( "refresh:2;url=booking.php");
                    }
