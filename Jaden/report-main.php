...
<title> Cacti Succulent Kuching | Analytics </title>
...
<?php
  ...
  for($x = 0; $x < 20; $x++){
    ...
    $querygetbookingscom = "SELECT count(ab.bookingID) AS count FROM bookings b JOIN acc_bookings ab ON b.bookingID = ab.bookingID WHERE (b.bookingDate = '2022-$bookingmonth-$bookingdate' AND ab.bookingCompleted = 1) GROUP BY bookingDate";
    ...
    $querygetbookingscan = "SELECT count(ab.bookingID) AS count FROM bookings b JOIN acc_bookings ab ON b.bookingID = ab.bookingID WHERE (b.bookingDate = '2022-$bookingmonth-$bookingdate' AND ab.bookingCompleted = 2) GROUP BY bookingDate";
    ...
    $querygetbookingsres = "SELECT count(ab.bookingID) AS count FROM bookings b JOIN acc_bookings ab ON b.bookingID = ab.bookingID WHERE (b.bookingDate = '2022-$bookingmonth-$bookingdate' AND ab.bookingCompleted = 0) GROUP BY bookingDate";
    ...
    <div class="footer-container">
      <div class="footer">
        ...
        <div class="footer-about">
          ...
          <h1>Cacti-Succulents Kuching is a business that was founded by Bob in 1978. He was 
            the only person to do this. The quick brown fox jumped over the lazy dog.
          </h1>
        </div>
        -->
