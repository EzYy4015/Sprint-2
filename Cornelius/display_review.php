                ...
                echo "<div class='user_review'>";
                    ...
                    echo "<div class = 'row1'>";
                        ...
                        echo "<div class = 'dropdown'>";
                            echo "<i class='fa-solid fa-ellipsis-vertical' onclick='Dropdown()' id='dropbtn' ></i>";
                            echo "<div id = 'myDropdown' class = 'dropdown_content'>";
                            echo "<a class = 'edit_button' href = 'edit_review.php?rID=$row[reviewID]&rRating=$row[reviewRating]&rComment=$row[reviewComment]'><i class='fa-solid fa-pen-to-square'></i>  Edit</a>";    
                            echo "<a class = 'delete_button' href = 'change_review_visibility.php?rID=$row[reviewID]'><i class='fa-solid fa-trash'></i>  Delete</a>";
                            echo "</div>";
                        echo "</div>";
                    echo "</div>";
