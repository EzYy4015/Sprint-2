<?php
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <td><a onclick = 'return confirmDelete()' class='booking_buttons' href='include/cancel_appointment.php?bID=$row[bookingID]&acID=$userID&btime=$row[bookingTime]&bdate=$row[bookingDate]'>Cancel</td>
