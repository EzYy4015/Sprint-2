...
<body>
    ...
    <div class="mainbody">
        ...
        <div class="bigcontainer-1">
            <div class="cardcontainer">
                <div class="bookingcard-row">
                    ...
                    while($resultsbookingslots = mysqli_fetch_array($querybookingslots)){
                        echo '
                        <a href="booking.php"><div class="bookingcard-col">
                            <div class="bookingcard">
                                <h1>'?> 

                                <?php echo $resultsbookingslots['bookingDate']; ?>
            ...
            <!-- notification on webpage -->
            <?php if ($_SESSION['loggedin'] == 1)
            {
                $accID = $_SESSION['userid'];
                include("include/notificationContentWebpage.php");
            ...
            }else
            {
                ...
                <div class="notifbox" id="notifbox">
                    <h1>Notifications</h1>
                    <div class="notif-individual" ><p><b>Please login to see your notification</b></p></div>
                </div>';
            } ?>
