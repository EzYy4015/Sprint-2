...
<head>
	...
	<title>Cacti Succulents - Add Promotion</title>
    ...
    <div class = "container">
        <div class="inner_container">
            ...
            <?php
                ...
                $promoAddedBy = $_SESSION['userid'];

                $addPromo = "INSERT INTO promotions(promoTitle, promoDesc, promoDuration, promoImage, promoVisible, promoAddedBy)
                                VALUES ('$promoTitle', '$promoDesc', '$promoDuration', '$promoImage', '$promoVisible', '$promoAddedBy')";
                ...
                mysqli_query($con, $addPromo);
                    
                //notification part
                $promoID = mysqli_insert_id($con);
                include ("include/promoNotification.php");
                getData($promoTitle,$promoDesc,$promoID);
