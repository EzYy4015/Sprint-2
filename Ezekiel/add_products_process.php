...
<head>
	...
	<title>Cacti Succulents - Add Products</title>
    ...
    <div class = "container">
        <div class="inner_container">
            ...
            <?php
                ...
                $prodAddedBy = $_SESSION['userid'];

                $addProd = "INSERT INTO products(prodTitle, prodDesc, prodImage, prodVisible, prodAddedBy)
                                VALUES ('$prodTitle', '$prodDesc', '$prodImage', '$prodVisible', '$prodAddedBy')";
                
                echo "<p>Note that only the latest 5 products will be shown in the page if there are more than 5 products set to visible.</p>";
                mysqli_query($con, $addProd);
