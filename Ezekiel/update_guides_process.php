        ...
        <div class="inner_container">
            ...
            <?php
                ...
                $updateGuide = "UPDATE guides
                                SET guideTitle = '$guideTitle',
                                    guideDesc = '$guideDesc',
                                    guideVisible = '$guideVisible'
                                WHERE guideID = $guideID";
                
                echo "<p>Note that only the 5 guides will be shown in the page if there are more than 5 guides set to visible.</p>";
                mysqli_query($con, $updateGuide);
