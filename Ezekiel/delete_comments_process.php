...
<head>
	...
	<title>Cacti Succulents - Delete Comment</title>
    ...
    <div class = "container">
        <div class="inner_container">
            ...
            <?php
                ...
                $deleteDisc = "DELETE FROM discussions WHERE discID = $discID";
                
                // Delete booking slots from acc_booking and bookings table
                if(mysqli_query($con, $deleteDisc)) {
                    if(mysqli_query($con, $deleteDisc)){
                        echo "<p class = 'success'>The comment has been deleted!</p>";
                    }     
                }
                else{
