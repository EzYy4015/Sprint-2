    ...
    <div class = "container">
        <div class="inner_container">
            ...
            <?php
                ...
                $discID = $_POST['discID'];
                $discVisible = $_POST['discVisible'];

                if ($discVisible == 1){
                    $updateDisc = "UPDATE discussions
                    SET discVisible = 0
                    WHERE discID = $discID";
                             
                    echo "<p>The visibility of this comment is updated successfully.</p>";
                    mysqli_query($con, $updateDisc);
                    
                }
                else{
                    $updateDisc1 = "UPDATE discussions
                    SET discVisible = 1
                    WHERE discID = $discID";
                    
                    echo "<p>The visibility of this comment is updated successfully.</p>";
                    mysqli_query($con, $updateDisc1);
                }
            ?>
