        ...
        <div class="slot_container">
            <fieldset class="slot_fieldset">
                ...
                <?php
                    ...
                    $query3 ="UPDATE bookings SET bookingAvailSlots=bookingAvailSlots+1 WHERE bookingID = '$bookingID';";
                    $query3.="DELETE FROM acc_bookings WHERE bookingID=$bookingID AND accID=$accID ";
                    ...
                    if($bookingDateTime>=$time_now){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "</table>";
                            $data = mysqli_multi_query($conn,$query3);
                        } 
